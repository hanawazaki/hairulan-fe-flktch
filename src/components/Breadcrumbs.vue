<template>
  <div class="py-3 flex items-center gap-3">
    <label class="text-sm font-normal text-[#696969]">Home</label>
    <svg
    ...
    <label class="text-sm font-normal text-[#696969]">Produk</label>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="13"
      height="13"
    ...
    <RouterLink class="text-sm font-normal text-customOrange" to="/"
      >Roasted Bean</RouterLink
    >
  </div>
</template>
